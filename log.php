...
<head>
    <meta charset="utf-8">
    <title>GCF/LCM Calculator! Log</title>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
			<div class="row">
				<div class="col-lg-8">
					<h1>GCF/LCM Calculator! Log</h1>
					<p class="d-print-none"><a href="#" data-toggle="modal" data-target="#myModal">About GCF/LCM Calculator! Log</a></p>
				</div>
            ...
            <div class="col">
				<?php
					try {
						...
						$stmt = $pdo->query("SELECT expr, time, ipaddr FROM gcflcm order by id desc limit 100");
						if ($stmt->execute() <> 0) :
				?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">GCF/LCM Calculator! Log</h4>
